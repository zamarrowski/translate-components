...
var Translate = function (_Component) {
  ...
  function Translate(props, context) {
    ...
    _this.debugMode = context.debugMode;
    _this.useRawText = props.useRawText; // useful to bind the text inside input placeholder, inside <option> elements, or when a <span> cannot be used
    _this.state = {
  ...
  _createClass(Translate, [{
    ...
    value: function render() {
      return this.useRawText ? this._getText(this.props.children) : _react2.default.createElement(
        'span',
        { style: this._getDebugModeStyles(this.props.children) },
    ...
    key: '_getDebugModeStyles',
    value: function _getDebugModeStyles(text) {
...
Translate.propTypes = {
  ...
  defaultLanguage: _propTypes2.default.string,
  debugMode: _propTypes2.default.bool,
  useRawText: _propTypes2.default.bool,
